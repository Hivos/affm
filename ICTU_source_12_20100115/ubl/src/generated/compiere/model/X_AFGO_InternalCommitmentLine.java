...
/** Generated Model for AFGO_InternalCommitmentLine
 *  @author Jorg Janke (generated) 
 *  @version Release 3.2.1 - $Id: X_AFGO_InternalCommitmentLine.java,v 1.3 2009/11/24 14:17:51 tomassen Exp $ */
public class X_AFGO_InternalCommitmentLine extends PO
{
    /** Standard Constructor
    @param ctx context
    @param AFGO_InternalCommitmentLine_ID id
    @param trxName transaction
    */
    public X_AFGO_InternalCommitmentLine (Ctx ctx, int AFGO_InternalCommitmentLine_ID, String trxName)
    {
        super (ctx, AFGO_InternalCommitmentLine_ID, trxName);
        
        /* The following are the mandatory fields for this object.
        
        if (AFGO_InternalCommitmentLine_ID == 0)
        {
            setAFGO_Activity_ID (0);
            setAFGO_InternalCommitmentLine_ID (0);
            ...
            setC_Charge_ID (0);
            setLine (0);	// @SQL=SELECT COALESCE(MAX(Line),0)+10 AS DefaultValue FROM AFGO_InternalCommitmentLine WHERE AFGO_InternalCommitment_ID=@AFGO_InternalCommitment_ID@
    ...
    @param trxName transaction
    */
    public X_AFGO_InternalCommitmentLine (Ctx ctx, ResultSet rs, String trxName)
    {
        super (ctx, rs, trxName);
        
    }
    /** Serial Version No */
    private static final long serialVersionUID = 27520554651789L;
    /** Last Updated Timestamp 2009-03-30 18:08:55.0 */
    public static final long updatedMS = 1238429335000L;
    /** AD_Table_ID=1000032 */
    public static final int Table_ID;
    
    static
    {
        Table_ID = get_Table_ID("AFGO_InternalCommitmentLine");
        
    }
    ;
    
    /** TableName=AFGO_InternalCommitmentLine */
    public static final String Table_Name="AFGO_InternalCommitmentLine";
    
    protected static KeyNamePair Model = new KeyNamePair(Table_ID,"AFGO_InternalCommitmentLine");
    ...
    */
    ...
    {
        if (AFGO_InternalCommitmentLine_ID < 1) throw new IllegalArgumentException ("AFGO_InternalCommitmentLine_ID is mandatory.");
    ...
    /** AFGO_InternalCommitment_ID AD_Reference_ID=1000034 */
    public static final int AFGO_INTERNALCOMMITMENT_ID_AD_Reference_ID=1000034;
    ...
    {
        return new KeyNamePair(get_ID(), String.valueOf(getAFGO_InternalCommitment_ID()));
