 ...
 *  @version Release 3.2.1 - $Id: X_C_Payment.java,v 1.2 2009/01/28 15:31:42 tomassen Exp $ */
public class X_C_Payment extends PO
{
    ...
    */
    public X_C_Payment (Ctx ctx, int C_Payment_ID, String trxName)
    {
    ...
    @param trxName transaction
    */
    public X_C_Payment (Ctx ctx, ResultSet rs, String trxName)
    {
    ...
    /** Last Updated Timestamp 2008-11-20 23:48:22.0 */
    ...
    */
    ...
    /** Set Add to Batch.
    @param AddPaymentToBatch Add to Batch */
    public void setAddPaymentToBatch (String AddPaymentToBatch)
    {
        set_Value ("AddPaymentToBatch", AddPaymentToBatch);
        
    }
    
    /** Get Add to Batch.
    @return Add to Batch */
    public String getAddPaymentToBatch() 
    {
        return (String)get_Value("AddPaymentToBatch");
