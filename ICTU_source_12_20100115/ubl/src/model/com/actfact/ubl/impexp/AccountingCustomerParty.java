 ...
 * @version $Id: AccountingCustomerParty.java,v 1.5 2010/01/06 12:05:27 tomassen Exp $
 * 
 */
public class AccountingCustomerParty extends CommonAggregateComponent
{
	AccountingCustomerParty(CommonAggregateComponent parent)
	{
		super(parent);
	}
	...
	protected boolean parseField(String nodeName, Node node)
	{
		if (CommonBasicComponent.PREFIX.equals(node.getPrefix()))
		{
			...
			else if (CommonBasicComponent.SupplierAssignedAccountID.equals(nodeName))
			{
				this.supplierAssignedAccountID = node.getTextContent();
				return true;
			}
			return false;
		}
	...
	public static final transient String NAME = "AccountingCustomerParty";
