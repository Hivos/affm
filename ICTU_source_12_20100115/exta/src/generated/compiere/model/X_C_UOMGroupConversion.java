 ...
 *  @version Release 3.2.1 - $Id: X_C_UOMGroupConversion.java,v 1.2 2009/03/31 16:43:32 tomassen Exp $ */
public class X_C_UOMGroupConversion extends PO
{
    ...
    */
    public X_C_UOMGroupConversion (Ctx ctx, int C_UOMGroupConversion_ID, String trxName)
    {
        super (ctx, C_UOMGroupConversion_ID, trxName);
    ...
    @param trxName transaction
    */
    public X_C_UOMGroupConversion (Ctx ctx, ResultSet rs, String trxName)
    {
