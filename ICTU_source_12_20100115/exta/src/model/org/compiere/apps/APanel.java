 ...
 *
 * 	@author 	Jorg Janke
 * 	@version 	$Id: APanel.java,v 1.5 2009/07/30 08:31:07 tomassen Exp $
 */
	...
	implements DataStatusListener, ChangeListener, ActionListener, ASyncProcess
{
	...
	//	menuBar.setHelpMenu();
		...
		aArchive =  addAction("Archive",		mGo, 	KeyStroke.getKeyStroke(KeyEvent.VK_F10, 0),	false);
	 ...
	 *	@param mTab tab
	 *	@param trxWindow first tab of trx window
	...
	public void dataStatusChanged (DataStatusEvent e)
	{
		...
		if (canHaveAttachment)
		{
			...
			aAttachmentExternal.setPressed(MEXTAAttachmentExternal.hasAttachment(this.m_ctx, m_curTab));
			// ExtAt;
	...
	private void cmd_attachmentExternal()
	{
		...
		new AttachmentExternal(Env.getFrame(this), m_ctx, m_curTab, null);
