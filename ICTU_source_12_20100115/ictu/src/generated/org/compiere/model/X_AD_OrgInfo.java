 ...
 *  @version Release 3.2.1 - $Id: X_AD_OrgInfo.java,v 1.23 2009/11/24 12:01:49 tomassen Exp $ */
public class X_AD_OrgInfo extends PO
{
    ...
    */
    public X_AD_OrgInfo (Ctx ctx, int AD_OrgInfo_ID, String trxName)
    {
    ...
    @param trxName transaction
    */
    public X_AD_OrgInfo (Ctx ctx, ResultSet rs, String trxName)
    {
    ...
    /** Last Updated Timestamp 2008-11-04 23:21:16.0 */
    ...
    */
    ...
    {
        if (AFGO_Calendar_ID <= 0) set_Value ("AFGO_Calendar_ID", null);
        else
