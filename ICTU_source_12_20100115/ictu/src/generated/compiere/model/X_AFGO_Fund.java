 ...
 *  @version Release 3.2.1 - $Id: X_AFGO_Fund.java,v 1.35 2009/11/24 12:01:47 tomassen Exp $ */
public class X_AFGO_Fund extends PO
{
    ...
    */
    ...
    /** Serial Version No */
    private static final long serialVersionUID = 27539889888789L;
    /** Last Updated Timestamp 2009-11-09 12:02:52.0 */
    public static final long updatedMS = 1257764572000L;
    /** AD_Table_ID=1000001 */
    ...
    */
    ...
    /** AFGO_FundProvider_ID AD_Reference_ID=1000005 */
    public static final int AFGO_FUNDPROVIDER_ID_AD_Reference_ID=1000005;
    /** Set Fund Provider.
    ...
    {
        return new KeyNamePair(get_ID(), String.valueOf(getAFGO_FundProvider_ID()));
        
    }
    
    
    /** AFGO_FundScheduleType_ID AD_Reference_ID=1000024 */
    public static final int AFGO_FUNDSCHEDULETYPE_ID_AD_Reference_ID=1000024;
    ...
    /** IsClosed AD_Reference_ID=1000054 */
    public static final int ISCLOSED_AD_Reference_ID=1000054;
    /** Close Funding = N */
    public static final String ISCLOSED_CloseFunding = X_Ref_AFGO_FundCloseReopen.CLOSE_FUNDING.getValue();
    /** Reopen Funding = Y */
    public static final String ISCLOSED_ReopenFunding = X_Ref_AFGO_FundCloseReopen.REOPEN_FUNDING.getValue();
    /** Is test a valid value.
    @param test testvalue
    @return true if valid **/
    public static boolean isIsClosedValid(String test)
    {
         return X_Ref_AFGO_FundCloseReopen.isValid(test);
    ...
    public void setIsClosed (String IsClosed)
    {
        ...
        throw new IllegalArgumentException ("IsClosed Invalid value - " + IsClosed + " - Reference_ID=1000054 - N - Y");
    ...
    /** Set Approved by Control.
    @param IsControlApproved Approved by Control */
    public void setIsControlApproved (boolean IsControlApproved)
    {
        set_Value ("IsControlApproved", Boolean.valueOf(IsControlApproved));
        
    }
    
    /** Get Approved by Control.
    @return Approved by Control */
    public boolean isControlApproved() 
    {
        return get_ValueAsBoolean("IsControlApproved");
    ...
    /** Set Approved by Selection Intake.
    @param IsSelectionIntakeApproved Approved by Selection Intake */
    ...
    /** Get Approved by Selection Intake.
    @return Approved by Selection Intake */
    ...
    /** Reference_Fund_ID AD_Reference_ID=1000001 */
    public static final int REFERENCE_FUND_ID_AD_Reference_ID=1000001;
    /** Set Reference Fund.
