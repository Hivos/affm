 ...
 *  @version Release 3.2.1 - $Id: X_AFGO_InvoiceLineAllocation.java,v 1.20 2009/11/24 12:01:47 tomassen Exp $ */
public class X_AFGO_InvoiceLineAllocation extends PO
{
    ...
    */
    public X_AFGO_InvoiceLineAllocation (Ctx ctx, int AFGO_InvoiceLineAllocation_ID, String trxName)
    {
        ...
        {
            setAFGO_Activity_ID (0);	// @AFGO_Activity_ID@
            setAFGO_InvoiceLineAllocation_ID (0);
            setAFGO_Month_ID (0);	// @AFGO_Month_ID@
            setAFGO_Phase_ID (0);	// @AFGO_Phase_ID@
            setAFGO_ProjectCluster_ID (0);	// @AFGO_ProjectCluster_ID@
            setAFGO_Project_ID (0);	// @AFGO_Project_ID@
            setAFGO_Quarter_ID (0);	// @AFGO_Quarter_ID@
            setAFGO_ServiceType_ID (0);	// @AFGO_ServiceType_ID@
    ...
    */
    ...
    /** Serial Version No */
    private static final long serialVersionUID = 27520549634789L;
    /** Last Updated Timestamp 2009-03-30 16:45:18.0 */
    public static final long updatedMS = 1238424318000L;
    /** AD_Table_ID=1000058 */
