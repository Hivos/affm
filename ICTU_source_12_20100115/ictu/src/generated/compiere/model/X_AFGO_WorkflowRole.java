 ...
 *  @version Release 3.2.1 - $Id: X_AFGO_WorkflowRole.java,v 1.24 2009/11/24 12:01:47 tomassen Exp $ */
public class X_AFGO_WorkflowRole extends PO
{
    ...
    */
    ...
    public static final int WORKFLOWROLETYPE_AD_Reference_ID=1000053;
    /** N/A = -- */
    ...
    public void setWorkflowRoleType (String WorkflowRoleType)
    {
        ...
        throw new IllegalArgumentException ("WorkflowRoleType Invalid value - " + WorkflowRoleType + " - Reference_ID=1000053 - -- - BM - BO - CO - EX - FA - FD - HR - LD - PD - QS - SI");
