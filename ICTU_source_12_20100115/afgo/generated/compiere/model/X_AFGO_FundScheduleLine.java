 ...
 *  @version Release 3.2.1 - $Id: X_AFGO_FundScheduleLine.java,v 1.1 2009/02/17 12:50:22 tomassen Exp $ */
public class X_AFGO_FundScheduleLine extends PO
{
    ...
    */
    ...
    /** AFGO_FundSchedule_ID AD_Reference_ID=1000020 */
    public static final int AFGO_FUNDSCHEDULE_ID_AD_Reference_ID=1000020;
    /** Set Fund Schedule.
    ...
    {
        if (AFGO_FundSchedule_ID <= 0) set_Value ("AFGO_FundSchedule_ID", null);
        else
        set_Value ("AFGO_FundSchedule_ID", Integer.valueOf(AFGO_FundSchedule_ID));
