 ...
 *  @version Release 3.2.1 - $Id: X_AD_Process_Para.java,v 1.1 2009/02/17 12:50:20 tomassen Exp $ */
public class X_AD_Process_Para extends PO
{
    ...
    */
    public X_AD_Process_Para (Ctx ctx, int AD_Process_Para_ID, String trxName)
    {
    ...
    @param trxName transaction
    */
    public X_AD_Process_Para (Ctx ctx, ResultSet rs, String trxName)
    {
        super (ctx, rs, trxName);
        
    }
    /** Serial Version No */
    private static final long serialVersionUID = 27507236790789L;
    /** Last Updated Timestamp 2008-10-27 13:44:34.0 */
    public static final long updatedMS = 1225111474000L;
    /** AD_Table_ID=285 */
    ...
    */
    ...
    /** Set Selection Only.
    @param IsSelectionOnly Selection Only */
    public void setIsSelectionOnly (boolean IsSelectionOnly)
    {
        set_Value ("IsSelectionOnly", Boolean.valueOf(IsSelectionOnly));
    ...
    {
        return get_ValueAsBoolean("IsSelectionOnly");
