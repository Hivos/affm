 ...
 *  @version Release 3.2.1 - $Id: X_C_OrderLine.java,v 1.1 2009/02/17 12:50:19 tomassen Exp $ */
public class X_C_OrderLine extends PO
{
    ...
    */
    public X_C_OrderLine (Ctx ctx, int C_OrderLine_ID, String trxName)
    {
    ...
    @param trxName transaction
    */
    public X_C_OrderLine (Ctx ctx, ResultSet rs, String trxName)
    {
    ...
    /** Last Updated Timestamp 2008-11-20 23:47:53.0 */
    ...
    */
    ...
    /** AFGO_FundLine_ID AD_Reference_ID=1000007 */
    public static final int AFGO_FUNDLINE_ID_AD_Reference_ID=1000007;
    /** Set Fund Line.
    ...
    {
        if (AFGO_FundLine_ID <= 0) set_Value ("AFGO_FundLine_ID", null);
        else
        set_Value ("AFGO_FundLine_ID", Integer.valueOf(AFGO_FundLine_ID));
    ...
    {
        if (AFGO_Fund_ID <= 0) set_Value ("AFGO_Fund_ID", null);
        else
        set_Value ("AFGO_Fund_ID", Integer.valueOf(AFGO_Fund_ID));
