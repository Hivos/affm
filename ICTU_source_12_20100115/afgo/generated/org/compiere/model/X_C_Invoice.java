 ...
 *  @version Release 3.2.1 - $Id: X_C_Invoice.java,v 1.1 2009/02/17 12:50:20 tomassen Exp $ */
public class X_C_Invoice extends PO
{
    ...
    */
    public X_C_Invoice (Ctx ctx, int C_Invoice_ID, String trxName)
    {
        ...
        if (C_Invoice_ID == 0)
        {
            ...
            setIsDeliveryAcknowledged (false);	// N
    ...
    @param trxName transaction
    */
    public X_C_Invoice (Ctx ctx, ResultSet rs, String trxName)
    {
        super (ctx, rs, trxName);
        
    }
    /** Serial Version No */
    private static final long serialVersionUID = 27508179397789L;
    /** Last Updated Timestamp 2008-11-07 11:34:41.0 */
    public static final long updatedMS = 1226054081000L;
    /** AD_Table_ID=318 */
    ...
    */
    ...
    /** AFGO_FundSchedule_ID AD_Reference_ID=1000030 */
    public static final int AFGO_FUNDSCHEDULE_ID_AD_Reference_ID=1000030;
    /** Set Fund Schedule.
    ...
    {
        if (AFGO_FundSchedule_ID <= 0) set_ValueNoCheck ("AFGO_FundSchedule_ID", null);
        else
    ...
    /** AFGO_PurchaseCommitment_ID AD_Reference_ID=1000032 */
    public static final int AFGO_PURCHASECOMMITMENT_ID_AD_Reference_ID=1000032;
    ...
    /** Set BPartner DocumentNo.
    @param BPartnerDocumentNo BPartner DocumentNo */
    public void setBPartnerDocumentNo (String BPartnerDocumentNo)
    {
        set_Value ("BPartnerDocumentNo", BPartnerDocumentNo);
        
    }
    
    /** Get BPartner DocumentNo.
    @return BPartner DocumentNo */
    public String getBPartnerDocumentNo() 
    {
        return (String)get_Value("BPartnerDocumentNo");
        
    }
    
    /** Set BPartner Payment Reference.
    @param BPartnerPaymentReference BPartner Payment Reference */
    public void setBPartnerPaymentReference (String BPartnerPaymentReference)
    {
        set_Value ("BPartnerPaymentReference", BPartnerPaymentReference);
        
    }
    
    /** Get BPartner Payment Reference.
    @return BPartner Payment Reference */
    public String getBPartnerPaymentReference() 
    {
        return (String)get_Value("BPartnerPaymentReference");
    ...
    /** Set Delivery Acknowledged.
    @param IsDeliveryAcknowledged Delivery Acknowledged */
    public void setIsDeliveryAcknowledged (boolean IsDeliveryAcknowledged)
    {
        set_Value ("IsDeliveryAcknowledged", Boolean.valueOf(IsDeliveryAcknowledged));
        
    }
    
    /** Get Delivery Acknowledged.
    @return Delivery Acknowledged */
    public boolean isDeliveryAcknowledged() 
    {
        return get_ValueAsBoolean("IsDeliveryAcknowledged");
    ...
    /** Set Payment Reference Valid.
    @param IsPaymentReferenceValid Payment Reference Valid */
    public void setIsPaymentReferenceValid (boolean IsPaymentReferenceValid)
    {
        set_Value ("IsPaymentReferenceValid", Boolean.valueOf(IsPaymentReferenceValid));
        
    }
    
    /** Get Payment Reference Valid.
    @return Payment Reference Valid */
    public boolean isPaymentReferenceValid() 
    {
        return get_ValueAsBoolean("IsPaymentReferenceValid");
