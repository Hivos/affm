 ...
 *  @version Release 3.2.1 - $Id: X_C_PaymentProcessor.java,v 1.1 2009/02/17 12:50:20 tomassen Exp $ */
public class X_C_PaymentProcessor extends PO
{
    ...
    */
    public X_C_PaymentProcessor (Ctx ctx, int C_PaymentProcessor_ID, String trxName)
    {
    ...
    @param trxName transaction
    */
    public X_C_PaymentProcessor (Ctx ctx, ResultSet rs, String trxName)
    {
        super (ctx, rs, trxName);
        
    }
    /** Serial Version No */
    private static final long serialVersionUID = 27515351674789L;
    /** Last Updated Timestamp 2009-01-29 11:52:38.0 */
    public static final long updatedMS = 1233226358000L;
    /** AD_Table_ID=398 */
    ...
    */
    ...
    {
        set_Value ("CommentLines", Integer.valueOf(CommentLines));
    ...
    {
        return get_ValueAsInt("CommentLines");
    ...
    /** Set Always include Name / City info.
    @param IsNameCity Always include Name / City info */
    public void setIsNameCity (boolean IsNameCity)
    {
        set_Value ("IsNameCity", Boolean.valueOf(IsNameCity));
        
    }
    
    /** Get Always include Name / City info.
    @return Always include Name / City info */
    public boolean isNameCity() 
    {
        return get_ValueAsBoolean("IsNameCity");
