 ...
 *  @version Release 3.2.1 - $Id: X_C_BP_BankAccount.java,v 1.1 2009/02/17 12:50:20 tomassen Exp $ */
public class X_C_BP_BankAccount extends PO
{
    ...
    */
    public X_C_BP_BankAccount (Ctx ctx, int C_BP_BankAccount_ID, String trxName)
    {
        ...
        if (C_BP_BankAccount_ID == 0)
        {
            ...
            setC_BPartner_ID (0);
            setIsACH (false);
            setIsAccountNoValidated (false);	// N
    ...
    */
    ...
    /** Serial Version No */
    private static final long serialVersionUID = 27505778294789L;
    /** Last Updated Timestamp 2008-10-10 17:36:18.0 */
    public static final long updatedMS = 1223652978000L;
    /** AD_Table_ID=298 */
    ...
    */
    ...
    /** Set AccountNo Validated.
    @param IsAccountNoValidated AccountNo Validated */
    public void setIsAccountNoValidated (boolean IsAccountNoValidated)
    {
        set_Value ("IsAccountNoValidated", Boolean.valueOf(IsAccountNoValidated));
        
    }
    
    /** Get AccountNo Validated.
    @return AccountNo Validated */
    public boolean isAccountNoValidated() 
    {
        return get_ValueAsBoolean("IsAccountNoValidated");
