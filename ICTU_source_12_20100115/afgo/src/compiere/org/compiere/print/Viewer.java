 ...
 *
 * 	@author 	Jorg Janke
 * 	@version 	$Id: Viewer.java,v 1.1 2009/08/17 09:17:33 tomassen Exp $
 */
...
//		comboZoom.addActionListener(this);
	...
	private void fillComboReport(int AD_PrintFormat_ID)
	{
		...
		Boolean windowAccess = MRole.getDefault().getWindowAccess(240); // Print Format
...
//		else
	...
	/**
	 * Sets the page indicator status and spinner status to the specified page number
	 * @param page
	 */
