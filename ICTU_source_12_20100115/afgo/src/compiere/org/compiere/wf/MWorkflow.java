 ...
 *
 * 	@author 	Jorg Janke
 * 	@version 	$Id: MWorkflow.java,v 1.1 2009/10/09 10:25:12 tomassen Exp $
 */
public class MWorkflow extends X_AD_Workflow
{
	...
	private static final CCache<String,MWorkflow[]>	s_cacheDocValue = new CCache<String,MWorkflow[]> ("AD_Workflow", 5);
	/**	Static Logger	*/
	...
	protected boolean afterSave (boolean newRecord, boolean success)
	{
			...
			|| is_ValueChanged("Description") || is_ValueChanged("Help"))
		{
			...
			for (X_AD_WF_Node element : nodes) {
				...
				// ActFact
				// 10022047
				// Do not override Node Name/Description
				/*
