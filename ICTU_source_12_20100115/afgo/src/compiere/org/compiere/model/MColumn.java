 ...
 *
 *  @author Jorg Janke
 *  @version $Id: MColumn.java,v 1.1 2009/10/29 12:04:26 tomassen Exp $
 */
	...
	protected boolean beforeSave (boolean newRecord)
	{
		...
		**/
		...
		if (isVirtualColumn())
		{
			...
			if (isUpdateable() && !(DisplayTypeConstants.Button == this.getAD_Reference_ID()))
			...
			if (getAD_Reference_ID() == DisplayTypeConstants.YesNo){
				...
				try {
					String search = "SELECT search_condition, constraint_name " +
							        ...
							        "AND table_name LIKE ?";
					pstmt = DB.prepareStatement(search,get_TrxName());
