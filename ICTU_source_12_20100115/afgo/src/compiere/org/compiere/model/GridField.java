 ...
 *
 *  @author Jorg Janke
 *  @version $Id: GridField.java,v 1.1 2009/10/29 12:04:26 tomassen Exp $
 */
	...
	implements Serializable, Evaluatee
{
	...
	{
		// ActFact
		// Allow process button for virtual column (zoom/Record_ID)
		if (isVirtualColumn() && !(DisplayTypeConstants.Button == this.getDisplayType()))
			return false;
	...
	public boolean isReadOnly()
	{
		// ActFact
		// Allow process button for virtual column (zoom/Record_ID)
		if (isVirtualColumn() && !(this.getDisplayType() == DisplayTypeConstants.Button))
			return true;
