 ...
 *	
 *  @author Jorg Janke
 *  @version $Id: CalloutInvoice.java,v 1.2 2009/06/02 12:27:30 tomassen Exp $
 */
@Deprecated
	...
	public String charge (Ctx ctx, int WindowNo, GridTab mTab, GridField mField, Object value)
	{
		...
		try
		{
			...
			if (rs.next())
			{
				 ...
				 * 
				 * ActFact 1352
				 * only set price to Charge Amount when not zero
				 */
				if (Env.ZERO.compareTo(rs.getBigDecimal(1)) != 0)
				{
