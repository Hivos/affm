 ...
 *
 *  @author 	Jorg Janke
 *  @version 	$Id: Lookup.java,v 1.2 2009/10/09 10:26:14 tomassen Exp $
 */
	...
	implements MutableComboBoxModel, Serializable
{
	...
	// ActFact
	// Disable restoring of tem/previous entries
	// This has been removed in Compiere 3.4.x, and seems to be the cause of a lot of
	// validation issues
	// Related tickets:
	// AFP: 3217, 3171, 3140
	// CMP: 10021435
	private final transient boolean ENABLE_TEMPDATA = false;
	// ActFact
	 ...
	 * Checks, if value has changed first.
