 ...
 *  @version Release 3.2.1 - $Id: X_C_Invoice.java,v 1.69 2010/01/04 13:30:17 tomassen Exp $ */
public class X_C_Invoice extends PO
{
    ...
    */
    ...
    /** Serial Version No */
    private static final long serialVersionUID = 27539388166789L;
    /** Last Updated Timestamp 2009-11-03 16:40:50.0 */
    public static final long updatedMS = 1257262850000L;
    /** AD_Table_ID=318 */
    ...
    */
    ...
    /** AFGO_PurchaseCommitment_ID AD_Reference_ID=1000011 */
    public static final int AFGO_PURCHASECOMMITMENT_ID_AD_Reference_ID=1000011;
    ...
    {
        if (AFGO_PurchaseCommitment_ID <= 0) set_Value ("AFGO_PurchaseCommitment_ID", null);
        else
        set_Value ("AFGO_PurchaseCommitment_ID", Integer.valueOf(AFGO_PurchaseCommitment_ID));
    ...
    /** Set Commitment Exceeded Amount.
    @param CommitmentExceededAmt Commitment Exceeded Amount */
    public void setCommitmentExceededAmt (java.math.BigDecimal CommitmentExceededAmt)
    {
        throw new IllegalArgumentException ("CommitmentExceededAmt is virtual column");
        
    }
    
    /** Get Commitment Exceeded Amount.
    @return Commitment Exceeded Amount */
    public java.math.BigDecimal getCommitmentExceededAmt() 
    {
        return get_ValueAsBigDecimal("CommitmentExceededAmt");
    ...
    /** Set Reset Invoice.
    @param ResetInvoice Reset Invoice */
    public void setResetInvoice (String ResetInvoice)
    {
        set_Value ("ResetInvoice", ResetInvoice);
        
    }
    
    /** Get Reset Invoice.
    @return Reset Invoice */
    public String getResetInvoice() 
    {
        return (String)get_Value("ResetInvoice");
