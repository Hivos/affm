 ...
 *  @version Release 3.2.1 - $Id: X_C_DocType.java,v 1.50 2010/01/04 13:30:16 tomassen Exp $ */
public class X_C_DocType extends PO
{
    ...
    */
    public X_C_DocType (Ctx ctx, int C_DocType_ID, String trxName)
    {
    ...
    @param trxName transaction
    */
    public X_C_DocType (Ctx ctx, ResultSet rs, String trxName)
    {
        super (ctx, rs, trxName);
        
    }
    /** Serial Version No */
    private static final long serialVersionUID = 27539280119789L;
    /** Last Updated Timestamp 2009-11-02 10:40:03.0 */
    public static final long updatedMS = 1257154803000L;
    /** AD_Table_ID=217 */
    ...
    */
    ...
    {
        if (AFGO_PurchaseCommitmentType_ID <= 0) set_Value ("AFGO_PurchaseCommitmentType_ID", null);
        else
        set_Value ("AFGO_PurchaseCommitmentType_ID", Integer.valueOf(AFGO_PurchaseCommitmentType_ID));
    ...
    /** BudgetType AD_Reference_ID=1000039 */
    public static final int BUDGETTYPE_AD_Reference_ID=1000039;
    /** Budget = B */
    ...
    public void setBudgetType (String BudgetType)
    {
        ...
        throw new IllegalArgumentException ("BudgetType Invalid value - " + BudgetType + " - Reference_ID=1000039 - B - P");
        set_Value ("BudgetType", BudgetType);
