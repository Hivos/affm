 ...
 *  @version Release 3.2.1 - $Id: X_AD_ClientInfo.java,v 1.44 2010/01/04 13:30:17 tomassen Exp $ */
public class X_AD_ClientInfo extends PO
{
    ...
    */
    public X_AD_ClientInfo (Ctx ctx, int AD_ClientInfo_ID, String trxName)
    {
    ...
    @param trxName transaction
    */
    public X_AD_ClientInfo (Ctx ctx, ResultSet rs, String trxName)
    {
