...
/** Generated Model for AFGO_Project
 *  @author Jorg Janke (generated) 
 *  @version Release 3.2.1 - $Id: X_AFGO_Project.java,v 1.69 2010/01/04 13:30:18 tomassen Exp $ */
public class X_AFGO_Project extends PO
{
    /** Standard Constructor
    @param ctx context
    @param AFGO_Project_ID id
    @param trxName transaction
    */
    public X_AFGO_Project (Ctx ctx, int AFGO_Project_ID, String trxName)
    {
        super (ctx, AFGO_Project_ID, trxName);
        
        /* The following are the mandatory fields for this object.
        
        if (AFGO_Project_ID == 0)
        {
    ...
    @param trxName transaction
    */
    public X_AFGO_Project (Ctx ctx, ResultSet rs, String trxName)
    {
        super (ctx, rs, trxName);
        
    }
    /** Serial Version No */
    private static final long serialVersionUID = 27520550129789L;
    /** Last Updated Timestamp 2009-03-30 16:53:33.0 */
    public static final long updatedMS = 1238424813000L;
    /** AD_Table_ID=1000003 */
    public static final int Table_ID;
    
    static
    {
        Table_ID = get_Table_ID("AFGO_Project");
        
    }
    ;
    
    /** TableName=AFGO_Project */
    public static final String Table_Name="AFGO_Project";
    
    protected static KeyNamePair Model = new KeyNamePair(Table_ID,"AFGO_Project");
    ...
    */
    ...
    {
        if (AFGO_Phase_ID <= 0) set_ValueNoCheck ("AFGO_Phase_ID", null);
        else
    ...
    {
        return new KeyNamePair(get_ID(), String.valueOf(getAFGO_ProjectCluster_ID()));
