 ...
 *  @version Release 3.2.1 - $Id: X_AFGO_FundSchedule.java,v 1.69 2010/01/04 13:30:17 tomassen Exp $ */
public class X_AFGO_FundSchedule extends PO
{
    ...
    */
    ...
    /** Serial Version No */
    private static final long serialVersionUID = 27539888770789L;
    /** Last Updated Timestamp 2009-11-09 11:44:14.0 */
    public static final long updatedMS = 1257763454000L;
    /** AD_Table_ID=1000021 */
    ...
    */
    ...
    /** C_DocType_ID AD_Reference_ID=1000044 */
    public static final int C_DOCTYPE_ID_AD_Reference_ID=1000044;
    /** Set Document Type.
    ...
    /** Set Funding closed for Invoicing.
    @param IsFundInvoiceClosed Funding closed for Invoicing */
    public void setIsFundInvoiceClosed (boolean IsFundInvoiceClosed)
    {
        throw new IllegalArgumentException ("IsFundInvoiceClosed is virtual column");
        
    }
    
    /** Get Funding closed for Invoicing.
    @return Funding closed for Invoicing */
    public boolean isFundInvoiceClosed() 
    {
        return get_ValueAsBoolean("IsFundInvoiceClosed");
