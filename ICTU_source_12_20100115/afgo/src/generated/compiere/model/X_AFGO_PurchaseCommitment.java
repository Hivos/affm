 ...
 *  @version Release 3.2.1 - $Id: X_AFGO_PurchaseCommitment.java,v 1.69 2010/01/04 13:30:18 tomassen Exp $ */
public class X_AFGO_PurchaseCommitment extends PO
{
    ...
    */
    ...
    /** Serial Version No */
    private static final long serialVersionUID = 27543013520789L;
    /** Last Updated Timestamp 2009-12-15 15:43:24.0 */
    public static final long updatedMS = 1260888204000L;
    /** AD_Table_ID=1000010 */
    ...
    */
    ...
    {
        throw new IllegalArgumentException ("IsAdditionalCommitment is virtual column");
    ...
    {
        throw new IllegalArgumentException ("IsCanHaveAdditional is virtual column");
    ...
    {
        throw new IllegalArgumentException ("IsCanTransfer is virtual column");
    ...
    {
        throw new IllegalArgumentException ("IsMasterCommitment is virtual column");
    ...
    {
        throw new IllegalArgumentException ("IsPurchaseDomain is virtual column");
    ...
    {
        throw new IllegalArgumentException ("IsQuotationRequired is virtual column");
    ...
    {
        throw new IllegalArgumentException ("IsSecondmentCommitment is virtual column");
    ...
    {
        throw new IllegalArgumentException ("IsTransferCommitment is virtual column");
    ...
    /** Set Target Total.
    @param TargetTotal Target Total */
    public void setTargetTotal (java.math.BigDecimal TargetTotal)
    {
        throw new IllegalArgumentException ("TargetTotal is virtual column");
        
    }
    
    /** Get Target Total.
    @return Target Total */
    public java.math.BigDecimal getTargetTotal() 
    {
        return get_ValueAsBigDecimal("TargetTotal");
